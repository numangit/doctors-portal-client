...
//   }
    ...
    return (
        <div className='sticky top-0 z-50'>
            ...
            <div className={color ? "navbar flex bg-teal-200/50 backdrop-blur-2xl justify-between dark:bg-accent/50" : "navbar bg-base-200 justify-between dark:bg-transparent"}>
